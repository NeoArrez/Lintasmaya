			...
			{!! Form::open(['route' => 'karyawan.store']) !!}
				...
				<div class="col-md-8">
					...
					<div class="col-md-12">
						...
						<a href="{{ route('karyawan.index') }}" class="btn btn-warning btn-lg btn-block" style='margin-top: 10px'>
							Cancel
						</a>

						</div>
						<div class="col-md-5">
				    		{!! Form::submit ('Tambahkan Karyawan', ['class'=>'btn btn-success btn-lg btn-block','style'=>'margin-top:10px;']) !!}
				    	</div>
					</div>
				</div>
			{!! Form::close() !!}
