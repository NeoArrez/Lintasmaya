			...
			{!! Form::open(['route' => 'pelanggan.store']) !!}
				...
				<div class="col-md-8">
					...
					<div class="col-md-3">
						...
						{!! Form::text('Bulanan', 0, ['class'=>'form-control','style'=>'text-align:right;']) !!}
					</div>
					<div class="col-md-3">
						{!! Form::label('TglAktivasi', 'Tgl Aktivasi') !!}
						{!! Form::text('TglAktivasi', \Carbon\Carbon::now()->format('d M Y'), ['class'=>'form-control','id'=>'datepicker', 'style'=>'text-align:center;']) !!}
					</div>
					<div class="row">
						<div class="col-md-12">
							<h3>Info Tekhnis</h3>
					...
					<div class="col-sm-4">
						...
						{!! Form::select('NamaBTS',array_merge(['' => 'Silahkan Pilih'],$btslists),null, ['class'=>'form-control selector btsselector']) !!}
					</div>
					<div class="col-sm-12">
					...
					<div class="col-md-12">
						...
						<a href="{{ route('pelanggan.index') }}" class="btn btn-warning btn-lg btn-block" style='margin-top: 10px'>
							Cancel
						</a>

						</div>
						<div class="col-md-5">
				    		{!! Form::submit ('Tambahkan Pelanggan', ['id'=>'btnSubmit','class'=>'btn btn-success btn-lg btn-block','style'=>'margin-top:10px;']) !!}
				    	</div>
					</div>
				</div>
			{!! Form::close() !!}
